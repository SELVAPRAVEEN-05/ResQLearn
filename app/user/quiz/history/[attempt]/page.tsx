...
const attemptDetails = {
  "flood-preparedness": {
    ...
    time: "6m 12s",
    summary:
      "Strong understanding of flood safety, with one missed detail on evacuation priority.",
  },
  "cyclone-basics": {
...
export default function QuizHistoryDetailPage(props: { params: any }) {
  ...
  const detail =
    attemptDetails[attemptKey] ?? attemptDetails["flood-preparedness"];
      ...
      <div className="rounded-3xl border border-[#E5E7EB] bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-center gap-3">
          <span
            className={
              detail.passed
                ? "rounded-full bg-[#D1FAE5] px-3 py-1 text-sm font-semibold text-[#047857]"
                : "rounded-full bg-[#FEE2E2] px-3 py-1 text-sm font-semibold text-[#DC2626]"
            }
          >
