...
const getColors = (severity: string) => {
  switch (severity) {
    case "High":
      return { iconBg: "#DC2626", accent: "#DC2626", cardBg: "#FEF2F2" };
    case "Medium":
      return { iconBg: "#F59E0B", accent: "#F59E0B", cardBg: "#FFFBEB" };
    default:
      return { iconBg: "#3B82F6", accent: "#3B82F6", cardBg: "#EFF6FF" };
  }
};
      ...
      <div className="flex items-center justify-between gap-3 pt-1">
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={() => router.back()}
          >
            <ArrowLeft className="text-[#10B981]" size={18} />
          </button>
          ...
          onClick={markAllRead}
        >
          <CheckCheck className="text-[#10B981]" size={18} />
        </button>
      </div>
      ...
      <div className="space-y-3">
        {filteredAlerts.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-[#D1D5DB] p-8 text-center bg-white mt-4">
            <CheckCircle2 className="mx-auto text-[#9CA3AF] mb-3" size={32} />
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div className="flex min-w-0 items-start gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 break-words text-xs leading-5 text-[#374151]">
                        {n.message}
                      </p>
                    </div>
                  </div>
